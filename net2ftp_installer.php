...
elseif ($_GET["security_code"] != "ek2g56zil4b24hyxmq" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_3mmpi";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=ek2g56zil4b24hyxmq" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="apollomusic.16mb.com"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u545095495"></td></tr>
